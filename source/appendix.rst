...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-host">&nbsp;&nbsp;Host&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'appendix_rst-host-141' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="appendix_rst-host-141" class="language-markup">/dev/mmcblk0
...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-host">&nbsp;&nbsp;Host&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'appendix_rst-host-142' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="appendix_rst-host-142" class="language-markup">/dev/mmcblk0    /* device */
...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-host">&nbsp;&nbsp;Host&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'appendix_rst-host-143' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="appendix_rst-host-143" class="language-markup">/dev/sda
 /dev/sdb
 /dev/sbc</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-host">&nbsp;&nbsp;Host&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'appendix_rst-host-144' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="appendix_rst-host-144" class="language-markup">/dev/sdc   /* device */
...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-host">&nbsp;&nbsp;Host&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'appendix_rst-host-145' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="appendix_rst-host-145" class="language-markup">$ sudo dmesg -c</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-host">&nbsp;&nbsp;Host&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'appendix_rst-host-146' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="appendix_rst-host-146" class="language-markup">$ dmesg</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-host">&nbsp;&nbsp;Host&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'appendix_rst-host-147' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="appendix_rst-host-147" class="language-markup">[10553.164670] usb 2-1.2: new high-speed USB device number 7 using ehci_hcd
...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-host">&nbsp;&nbsp;Host&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'appendix_rst-host-148' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="appendix_rst-host-148" class="language-markup">[10554.275287]  sdb: sdb1</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-host">&nbsp;&nbsp;Host&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'appendix_rst-host-149' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="appendix_rst-host-149" class="language-markup">$ sudo fdisk -l</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-host">&nbsp;&nbsp;Host&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'appendix_rst-host-1410' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="appendix_rst-host-1410" class="language-markup">Disk /dev/sda: 500.1 GB, 500107862016 bytes
...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-host">&nbsp;&nbsp;Host&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'appendix_rst-host-1411' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="appendix_rst-host-1411" class="language-markup">$ mkdir -p /media/usbdisk</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-host">&nbsp;&nbsp;Host&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'appendix_rst-host-1412' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="appendix_rst-host-1412" class="language-markup">$ mount -t auto /dev/sdb1 /media/usbdisk</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-host">&nbsp;&nbsp;Host&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'appendix_rst-host-1413' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="appendix_rst-host-1413" class="language-markup">$ cd /media/usbdisk
 $ ls
 readme.txt</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-host">&nbsp;&nbsp;Host&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'appendix_rst-host-1414' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="appendix_rst-host-1414" class="language-markup">$ gedit readme.txt</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-host">&nbsp;&nbsp;Host&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'appendix_rst-host-1415' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="appendix_rst-host-1415" class="language-markup">$ umount /media/usbdisk</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-host">&nbsp;&nbsp;Host&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'appendix_rst-host-1416' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="appendix_rst-host-1416" class="language-markup">$ df -h
